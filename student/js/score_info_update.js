var xmlHttp
			...
			if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
			 { 
			 	...
			 	for(var x=0;x<cut_base_inforlength-1;x++){
			 			...
			 			//alert(gid)
			 			var score=cut_base_infor[x].split(",")[2];
			 			// alert(time)
	...
	setLevel(level,id1,str);
}
function setLevel(level,id1,str)
{
	xmlHttp=setGetXmlHttpObject()
			...
			var url="php/score_info_update.php?level="+level+"&id="+id1+"&q="+str
			//alert(url)
			// alert(url);
